...
class PPTTasks:
    ...
    def presentation_generation_task(self, agent, design_result):
        ...
        return Task(
            description=f'''
            Create individual HTML files for each slide following strict layout and styling guidelines.
            ...
            1. Structure:
               - Use the provided HTML structure template EXACTLY
               - Each slide must be a self-contained HTML file
               - Maintain 16:9 aspect ratio (1920x1080px)
               - No JavaScript or external resources

            2. Content Layout:
               - All content must be within .slide-content div
               - Title in .slide-title
               - Main content in .slide-body
               - Use appropriate content class based on type:
            ...
            3. Content Handling:
               ...
               - For bullet points, limit to 6 items
               - For paragraphs, use short, readable blocks
               - Add source-citation class for references
            ...
            6. Critical Rules:
               - NO inline styles
               - NO custom CSS outside template
